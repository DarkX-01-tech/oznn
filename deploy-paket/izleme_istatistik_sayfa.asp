...
function modalKapat(){document.getElementById('detayModal').classList.remove('show');var dm=document.getElementById('degisiklikModal');if(!dm||!dm.classList.contains('show'))document.body.style.overflow='';}
function degisiklikModalAc(){var m=document.getElementById('degisiklikModal');if(!m)return;m.classList.add('show');m.style.display='flex';document.body.style.overflow='hidden';}
function degisiklikModalKapat(){var m=document.getElementById('degisiklikModal');if(!m)return;m.classList.remove('show');m.style.display='none';var d=document.getElementById('detayModal');if(!d||!d.classList.contains('show'))document.body.style.overflow='';}
document.addEventListener('DOMContentLoaded',function(){var b=document.getElementById('degisiklikAcBtn');if(b)b.addEventListener('click',function(e){e.preventDefault();degisiklikModalAc();});var k=document.getElementById('degisiklikModalKapatBtn');if(k)k.addEventListener('click',function(e){e.preventDefault();degisiklikModalKapat();});var m=document.getElementById('degisiklikModal');if(m)m.addEventListener('click',function(e){if(e.target===m)degisiklikModalKapat();});});
