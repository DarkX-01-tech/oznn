  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .btn-yeni {
      ...
      padding: 8px 18px; border: 2px solid rgba(255,255,255,0.3);
      border-radius: 20px; text-decoration: none; font-size: 13px;
      font-weight: 600; transition: all 0.3s;
      display: flex; align-items: center; gap: 6px;
    }
    .btn-yeni:hover { background: rgba(255,255,255,0.3); transform: translateY(-2px); }
    .btn-yeni svg { width: 16px; height: 16px; }
...
<body>
  ...
  <div id="header">
    <div id="nav-buttons">
      ...
      <a href="panel.asp" class="nav-button" title="Panele D&#246;n">
