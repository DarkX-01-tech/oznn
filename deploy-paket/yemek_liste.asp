...
ElseIf Request.QueryString("durum") = "guncellendi" Then
    basarili_mesaj = "Kay&#305;t ba&#351;ar&#305;yla g&#252;ncellendi!"
ElseIf Request.QueryString("durum") = "toplu_silindi" Then
    basarili_mesaj = "T&#252;m kay&#305;tlar ba&#351;ar&#305;yla silindi!"
ElseIf Request.QueryString("durum") = "eklendi" Then
    basarili_mesaj = "Yeni men&#252; ba&#351;ar&#305;yla eklendi!"
...
<head>
  ...
  <title>Yemek Listesi - Y&#246;netim Paneli</title>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    #search-bar {
      ...
      border: 1px solid rgba(255,255,255,0.3); width: 200px;
      font-size: 13px; background: rgba(255,255,255,0.9); transition: all 0.3s;
    }
    ...
    .alert {
      ...
      font-size: 14px; animation: slideDown 0.3s; display: flex;
    ...
    .sekme-btn {
      ...
      border: 2px solid transparent; color: #777;
    ...
    .liste-container {
      ...
      box-shadow: 0 6px 20px rgba(0,0,0,0.06); overflow: hidden;
    }
    .liste-header {
      background: linear-gradient(135deg, var(--main), var(--dark));
    ...
    .liste-header-actions { display: flex; align-items: center; gap: 10px; }
    .btn-yillik, .btn-yeni {
    ...
    .btn-yeni { font-size: 13px; padding: 8px 18px; }
    .btn-yillik:hover, .btn-yeni:hover { background: rgba(255,255,255,0.3); transform: translateY(-2px); }
    .btn-yillik svg, .btn-yeni svg { width: 16px; height: 16px; fill: currentColor; }
    ...
    .ay-kart {
      ...
      padding: 0; transition: all 0.35s cubic-bezier(0.22,1,0.36,1);
      position: relative; overflow: hidden;
    }
    .ay-kart:hover {
      border-color: var(--main);
      box-shadow: 0 12px 30px rgba(69,184,195,0.18);
      transform: translateY(-5px);
    }
    .ay-kart.diyet-kart:hover {
      border-color: var(--diyet);
      box-shadow: 0 12px 30px rgba(76,175,80,0.18);
    }
    .ay-kart-top {
      background: linear-gradient(135deg, rgba(69,184,195,0.06), rgba(46,139,145,0.03));
      padding: 20px 20px 16px 20px;
      border-bottom: 1px solid #f0f0f0;
    }
    .ay-kart.diyet-kart .ay-kart-top {
      background: linear-gradient(135deg, rgba(76,175,80,0.06), rgba(56,142,60,0.03));
    }
    .ay-kart-header {
      display: flex; align-items: center; justify-content: space-between;
      margin-bottom: 14px;
    ...
    .ay-kart.diyet-kart .ay-kart-icon {
      background: linear-gradient(135deg, var(--diyet), var(--diyet-dark));
    }
    ...
    .ay-kart.diyet-kart .ay-kart-badge {
      background: linear-gradient(135deg, var(--diyet), var(--diyet-dark));
    }
    ...
    .ay-kart.diyet-kart .info-item svg { fill: var(--diyet); }

    .ay-kart-footer { padding: 14px 20px; display: flex; gap: 8px; }

    .btn-detay, .btn-istatistik {
    ...
    .btn-detay:hover, .btn-istatistik:hover {
      background: linear-gradient(135deg, var(--main), var(--dark));
      color: #fff; border-color: var(--main);
      transform: translateY(-2px);
      box-shadow: 0 6px 16px rgba(69,184,195,0.4);
    }
    .btn-detay:hover svg, .btn-istatistik:hover svg { fill: #fff; }

    .ay-kart.diyet-kart .btn-detay,
    .ay-kart.diyet-kart .btn-istatistik {
      color: var(--diyet-dark); border-color: var(--diyet);
    }
    .ay-kart.diyet-kart .btn-detay svg,
    .ay-kart.diyet-kart .btn-istatistik svg { fill: var(--diyet-dark); }
    .ay-kart.diyet-kart .btn-detay:hover,
    .ay-kart.diyet-kart .btn-istatistik:hover {
      background: linear-gradient(135deg, var(--diyet), var(--diyet-dark));
      border-color: var(--diyet);
      box-shadow: 0 6px 16px rgba(76,175,80,0.4);
      color: #fff;
    }
    .ay-kart.diyet-kart .btn-detay:hover svg,
    .ay-kart.diyet-kart .btn-istatistik:hover svg { fill: #fff; }
    ...
    .bos-durum p { font-size: 14px; margin: 0 0 25px 0; }
...
<body>
  ...
  <div id="header">
    <div id="nav-buttons">
      ...
      <a href="yemek_liste.asp" class="nav-button active" title="Yemek Listesi">
  ...
  <div class="content">
    ...
    <div class="sekme-wrapper">
      <a href="yemek_liste.asp?sekme=normal" class="sekme-btn<% If aktif_sekme = "normal" Then %> aktif-normal<% End If %>">
        <svg viewBox="0 0 24 24"><path d="M11 9H9V2H7v7H5V2H3v7c0 2.12 1.66 3.84 3.75 3.97V22h2.5v-9.03C11.34 12.84 13 11.12 13 9V2h-2v7zm5-3v8h2.5v8H21V2c-2.76 0-5 2.24-5 4z"/></svg>
        Yemek Listesi
      </a>
      <a href="yemek_liste.asp?sekme=diyet" class="sekme-btn<% If aktif_sekme = "diyet" Then %> aktif-diyet<% End If %>">
    ...
    <div class="liste-container">
      <div class="liste-header<% If aktif_sekme = "diyet" Then %> diyet-header<% End If %>">
        <h2>
          <% If aktif_sekme = "diyet" Then %>
        ...
        <div class="liste-header-actions">
          <a href="yemek_istatistik_yillik.asp?yil=<%= Year(Now()) %><% If aktif_sekme = "diyet" Then %>&tip=diyet<% End If %>" class="btn-yillik">
            <svg viewBox="0 0 24 24"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/></svg>
            Y&#305;ll&#305;k &#304;statistik
          </a>
          <a href="yemek_ekle.asp" class="btn-yeni">
      ...
      <div class="ay-kartlari">
        ...
        %>
        <div class="ay-kart<% If aktif_sekme = "diyet" Then %> diyet-kart<% End If %>">
          <div class="ay-kart-top">
            <div class="ay-kart-header">
              <div class="ay-kart-title">
                ...
                <div>
                  <h3><%= ay_adi %> <span>/ <%= rsAylar("yil") %></span></h3>
                </div>
              </div>
            ...
            <div class="ay-kart-info">
              <div class="info-item">
                ...
                <span>Toplam <%= rsAylar("kayit_sayisi") %> kay&#305;t</span>
              </div>
              <% If rsAylar("aktif_var") = True Then %>
              <div class="info-item">
                <svg viewBox="0 0 24 24" fill="currentColor"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></svg>
                <span>Aktif kay&#305;tlar mevcut</span>
              </div>
              <% End If %>
            </div>
          </div>
          ...
          <div class="ay-kart-footer">
            <a href="yemek_liste_detay.asp?yil=<%= rsAylar("yil") %>&ay=<%= rsAylar("ay") %><% If aktif_sekme = "diyet" Then %>&tip=diyet<% End If %>" class="btn-detay">
              <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></svg>
              Detaylar&#305; G&#246;r
            </a>
            <a href="yemek_istatistik.asp?yil=<%= rsAylar("yil") %>&ay=<%= rsAylar("ay") %><% If aktif_sekme = "diyet" Then %>&tip=diyet<% End If %>" class="btn-istatistik">
      ...
      <div class="bos-durum">
        ...
        <p>Yeni diyet yemek men&#252;s&#252; kayd&#305; eklemek i&#231;in a&#351;a&#287;&#305;daki butona t&#305;klay&#305;n</p>
        <% Else %>
        <svg viewBox="0 0 24 24"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-5 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z"/></svg>
        <h3>Hen&#252;z kay&#305;t bulunmuyor</h3>
        <p>Yeni yemek men&#252;s&#252; kayd&#305; eklemek i&#231;in a&#351;a&#287;&#305;daki butona t&#305;klay&#305;n</p>
        <% End If %>
        <a href="yemek_ekle.asp" class="btn-yeni" style="display:inline-flex; background:linear-gradient(135deg,<% If aktif_sekme="diyet" Then %>var(--diyet),var(--diyet-dark)<% Else %>var(--main),var(--dark)<% End If %>); border-color:transparent;">
          <svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>
          Yeni Kay&#305;t Ekle
        </a>
      </div>
